...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 23, 2019 at 02:15 PM
...
INSERT INTO `clients` (`id`, `name`, `address`, `mbl_no`, `birth_date`, `nationality`, `company_name`, `company_address`, `company_mbl_no`, `city_country`, `email`, `website`, `description`, `status`, `action_type`, `user_code`, `created_at`, `updated_at`) VALUES
(2, 'Md Kawser', 'ctg', '01000222222', '2019-10-16', 'BD', 'Shoilpik', 'ctg', '01000222222', 'ctg', 'user@shoilpik.com', '', NULL, 1, 'insert', '32', '2019-10-15 06:16:35', '2019-10-15 06:16:35');
...
CREATE TABLE `expense_heads` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `expense_head` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `description` longtext COLLATE utf8mb4_unicode_ci,
  `action_type` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `user_code` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
...
(22, '2019_10_06_075610_create_project_masters_table', 7),
(23, '2019_10_06_080051_create_project_details_table', 7),
(24, '2019_09_29_101618_create_clients_table', 8),
(25, '2019_10_15_102112_create_expense_heads_table', 8),
(26, '2019_10_15_105854_create_expenses_table', 8);
...
CREATE TABLE `project_details` (
  ...
  `is_transaction` tinyint(4) DEFAULT '0',
  `action_type` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `user_code` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
...
INSERT INTO `project_details` (`id`, `project_master_id`, `item_type_id`, `description`, `amount`, `start_date`, `delivery_date`, `next_billing_date`, `recurring_month`, `is_recurring`, `is_transaction`, `action_type`, `user_code`, `created_at`, `updated_at`) VALUES
(1, 1, 3, 'test---', 10000.00, '2019-10-22', '2019-10-16', '2019-10-22', 1, 1, 1, 'update', '32', '2019-10-14 02:36:19', '2019-10-14 07:34:52'),
(2, 3, 3, 'test', 200.00, '2019-10-15', '2019-10-15', '2019-10-15', 1, 0, 1, 'update', '32', '2019-10-14 02:42:10', '2019-10-14 07:48:43'),
(3, 4, 3, 'test', 200.00, '2019-10-15', '2019-10-15', '2019-10-15', 1, 1, 1, 'update', '32', '2019-10-14 02:43:57', '2019-10-14 07:55:06'),
(4, 4, 3, '---', 10000.00, '2019-10-15', '2019-10-16', '2019-10-16', 1, 0, 1, 'update', '32', '2019-10-14 07:37:31', '2019-10-14 07:55:18'),
(5, 4, 3, '---', 10000.00, '2019-10-23', '2019-10-23', '2019-10-15', 1, 1, 0, 'insert', '32', '2019-10-14 07:43:12', '2019-10-14 07:43:12');
...
CREATE TABLE `project_masters` (
  ...
  `installation_charge` double(8,2) NOT NULL,
  `service_charge` double(8,2) NOT NULL DEFAULT '0.00',
  `total_project_value` double(8,2) DEFAULT NULL,
  `start_date` date NOT NULL,
  `delivery_date` date DEFAULT NULL,
  `status` int(11) NOT NULL DEFAULT '1',
  `action_type` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `project_masters` (`id`, `name`, `client_id`, `project_category_id`, `installation_charge`, `service_charge`, `total_project_value`, `start_date`, `delivery_date`, `status`, `action_type`, `user_code`, `created_at`, `updated_at`) VALUES
(1, 'Shoilpik ERP', 2, 1, 2000.00, 2000.00, 2000.00, '2019-10-15', '2019-10-17', 1, 'update', '32', '2019-10-14 02:36:18', '2019-10-14 06:45:35'),
(3, 'Shoilpik ERP', 2, 1, 1000.00, 1000.00, 2000.00, '2019-10-15', '2019-10-16', 1, 'insert', '32', '2019-10-14 02:42:10', '2019-10-14 02:42:10'),
(4, 'Shoilpik ERP', 2, 1, 1000.00, 1000.00, 2000.00, '2019-10-15', '2019-10-16', 1, 'update', '32', '2019-10-14 02:43:57', '2019-10-14 23:37:27');
